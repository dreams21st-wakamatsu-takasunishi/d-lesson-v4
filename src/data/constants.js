...
const BASIC_HIRAGANA_WORDS = [
    'あさ','いえ','うみ','えき','おに','かさ','きく','くも','けむり','こえ',
    'さかな','しお','すな','せみ','そら','たこ','ちず','つくえ','てら','とり',
    'なす','にわ','ぬの','ねこ','のり','はな','ひる','ふね','へび','ほし',
    'まめ','みみ','むし','め','もり','やま','ゆめ','よる','らくだ','りす',
    'るす','れきし','ろば','わに','ほんをよむ','ぎん','ぐみ','げた','ごま','ざる',
    'みず','かぜ','ぞう','だるま','つづく','でんわ','ばら','ぶた','ぼうし','ぱん','ぴあの','ぷりん','ぺん','ぽすと',
    'がく','にじ','ちぢむ','まど','かべ'
].map(h => ({ h, r: [] }));
...
export const WORD_DATA =[
    ...
    { id: 4004, title: '「ゃ・ゅ・ょ」テスト', mode:'blind', chars:['きゃく','きゅうり','きょうりゅう','しゃしん','しゅくだい','しょうゆ','ちゃいろ','ちゅうい','ちょきん','にゅうがく','ひゃく','りょこう'].map(h => ({h,r:[]}))},
    { id: 4005, title: '小さい「ぁ・ぃ・ぅ・ぇ・ぉ」', mode:'guided', chars:['ぁ','ぃ','ぅ','ぇ','ぉ','ふぁ','ふぃ','ふぇ','ふぉ','てぃ','でぃ'].map(h => ({h,r:[]}))},
    { id: 4006, title: '小さい母音テスト', mode:'blind', chars:['ふぁいる','ふぃるむ','ふぇす','ふぉーく','てぃっしゅ','でぃすく'].map(h => ({h,r:[]}))},
    { id: 4007, title: '小さい「っ」', mode:'guided', chars:['っ','きって','きっぷ','がっこう','ざっし','ピッピ'].map(h => ({h,r:[]}))},
    { id: 4008, title: '「っ」テスト', mode:'blind', chars:['きって','きっぷ','がっこう','らっぱ','ざっし','ピッピ'].map(h => ({h,r:[]}))},
    { id: 4009, title: 'のばす音「ー」', mode:'guided', chars:['ー','けーき','すーぱー','こーひー','すぽーつ','のーと'].map(h => ({h,r:[]}))},
    { id: 4010, title: 'むずかしい音テスト', mode:'blind', chars:['けーき','すーぱー','ピッピ','きょうりゅう','ふぉーく','てぃっしゅ'].map(h => ({h,r:[]}))},
...
export const KB_CHAPTERS =[
    ...
    {id:'word3',title:'小さい母音',stages:[4005,4006],bridge:null,exam:null},
    {id:'word4_special',title:'小さい「っ」',stages:[4007,4008],bridge:null,exam:4102},
    {id:'word5_special',title:'のばす音とまとめ',stages:[4009,4010],bridge:null,exam:4103},
    {id:'word_summary',title:'むずかしい音まとめ',stages:[4999],bridge:null,exam:null},
    {id:'word4',title:'ことばのれんしゅう(つかうことば)',stages:[4011,4012,4013],bridge:null,exam:4104},
    {id:'word5',title:'ことばのれんしゅう(ぶんのきほん)',stages:[4014,4015],bridge:null,exam:4105},
